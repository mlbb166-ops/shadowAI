...
DATASET_LARGE = Path("/home/ubuntu/nutrishield-drive/assets/Shadow AI/food-dataset-10.000+")
DATASET_BASE = Path("/home/ubuntu/nutrishield-drive/assets/Shadow AI/food-dataset")
INPUTS = (
                ...
                with path.open("r", encoding="utf-8-sig", newline="") as handle:
                    for index, row in enumerate(csv.DictReader(handle), start=1):
                        ...
                        conn.execute(
                            ...
                            (canonical_id, raw_id, "official_code" if rtype == "whole_food_index" else "barcode" if barcode else "bpom_number" if bpom else "standalone", provenance),
                        )
